...
vector<double> gaussJacobi(const vector<vector<double>> &a, const vector<double> &b, int numIt)
{
...
vector<double> gaussSeidel(const vector<vector<double>> &a, const vector<double> &b, int numIt)
{
...
int main()
{
	...
	solutions = gaussSeidel(matrix, b, 1);
	//solutions = gaussJacobi(matrix, b,2);
